...
execute as @e run scoreboard players get @p[scores={bedSlept=1..},limit=1] bedSlept
# Summon an entity with the respect tag
execute as @e run summon minecraft:area_effect_cloud ~ ~5 ~ {Tags:["bedSlept"]}
# Teleport the recently summoned entity to closest player that slept.
execute as @e run tp @e[tag=bedSlept,limit=1] @p[scores={bedSlept=1..}]
# Tell the player who is getting their cords saved
execute as @e run tell @p[scores={bedSlept=1..}] Your home position is to be saved...
...
execute as @e run scoreboard players operation @e[type=minecraft:player,scores={bedSlept=1..}] spawnX >< @e[tag=bedSlept,limit=1] spawnX
...
# ^
execute as @e run scoreboard players operation @e[type=minecraft:player,scores={bedSlept=1..}] spawnY >< @e[tag=bedSlept,limit=1] spawnY
...
# ^
execute as @e scoreboard players operation @e[type=minecraft:player,scores={bedSlept=1..}] spawnZ >< @e[tag=bedSlept,limit=1] spawnZ
# Set the players bedSlept scoreboard back to 0 so they dont accidentally trigger an infinite loop.
execute as @e scoreboard players set @p[scores={bedSlept=1..}] bedSlept 0
